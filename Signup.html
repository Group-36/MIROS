        ...
        <form style="display: flex; justify-content: space-between;">
            ...
            <div style="flex: 0 0 calc(50%);">
                ...
                <div class="checkbox" style="margin-left: -900px; margin-top: 75px;">
                    ...
                    <button id="myButton" class="btn btn-primary" style="background-color: rgb(249, 99, 50);; color: white; border-radius: 20px; width: 130px; height: 50px; text-align: center;">Get Started</button>
            </div>
        </form>
    </div>
</body>
