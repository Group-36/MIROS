...
$stmt = $db->prepare('INSERT INTO SignUpRequests (request_id, signup_fn, signup_ln, signup_DOB, signup_email, signup_password) VALUES (:request_id, :signup_fn, :signup_ln, :signup_DOB, :signup_email, :signup_password)');
